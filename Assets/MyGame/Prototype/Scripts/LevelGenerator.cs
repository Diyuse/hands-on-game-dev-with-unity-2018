    ...
    public class LevelGenerator : MonoBehaviour
    {
        ...
        private void GenerateObstacle()
        {
            ...
            while (attempts < 5 && !slotFound)
            {
                ...
                int z = Random.Range((int)levelCenter.z - levelHeight / 2, (int)levelCenter.z + levelWidth / 2);
        ...
        private bool TestPoint(Vector3 pointToTest, List<Vector3> otherPoints)
        {
            ...
            {
                return false; // Prevent putting things in the safe volume
            }

            if (otherPoints.Count == 0)
            {
                return true; // If no other obstacle then its good
            }
            ...
            foreach (Vector3 otherPoint in otherPoints)
            {
                ...
                {
                    return false; // For each other obstacle check if the distance is more than the buffer
                }
            }
            return true;
        }
